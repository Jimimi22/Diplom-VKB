...
<div class="title"><img src="../resources/images/shoutbox.png"></div>
...
<div style="background-color: #ded6b6;">
...
<div class="wrapper" style="padding-top:  10px;">
	<div style="float: left; fomt-size: 10px;">Нажмите "Enter" или кнопку<br />для отправки</div>
    <a href="#" id="shoutbox" class="link3"><em><b>Отправить</b></em></a>
</div>